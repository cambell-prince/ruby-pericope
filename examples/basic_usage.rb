...
# Fuzzy matching
mathew = Pericope::Book.find_by_name("Mathew") # misspelled
...
all_books = Pericope::Book.all_books
old_testament = Pericope::Book.testament_books(:old)
new_testament = Pericope::Book.testament_books(:new)
